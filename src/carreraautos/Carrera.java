    ...
    public void run() {
        ...
        if (eti.getLocation().x >= p.getlbl_barrera().getLocation().x - 10) {
            if (c1 > c2 && c1 > c3) {
                ...
                p.getlbl_resultado().setText("Gano 1");
            } else if (c2 > c1 && c2 > c3) {
                //JOptionPane.showMessageDialog(null, "Gano 2");
                p.getlbl_resultado().setText("Gano 2");
            } else if (c3 > c1 && c3 > c2) {
                //JOptionPane.showMessageDialog(null, "Gano 3");
                p.getlbl_resultado().setText("Gano 3");
            } else {

               // JOptionPane.showMessageDialog(null, "Empate");
               p.getlbl_resultado().setText("Empate");
               //p.dispose();  //SI SE QUIERE TERMINAR Y CERRAR LA VENTANA
            }
